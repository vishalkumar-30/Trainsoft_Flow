...
const QuizSetting = ({ show, setShow, setStep }) => {
            ...
            >
                {({ handleSubmit }) => (
                     ...
                     <div className="row aic">
                         ...
                         <div className="col-sm-12"><div className="small-text">Time limit for this quiz. 0 means no time limit.</div></div>
                     ...
                     <div className="jcb">
                         <div>
                             <Button className=" py-2 mt-2 mr-2" onClick={() => { setStep('question') }}> Back </Button>
