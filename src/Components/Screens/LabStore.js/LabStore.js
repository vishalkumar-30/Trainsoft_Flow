...
const dummyData = [
  {
    ...
    pic: "https://mountainss.files.wordpress.com/2018/06/devops-tool-chain.png",
    icon: ICN_ON_GOING,
    link: "",
    desc: "Implement, deploy, migrate and maintain application in the cloud",
  },
  {
    label: "Website Development",
    icon: ICN_ON_GOING,
    link: "",
    desc: "For software engineers who develop web applications in the cloud",
  },
  {
    label: "App Development",
    icon: ICN_ON_GOING,
    link: "",
    desc: "For developer who develops mobile apps in the cloud",
  },
  {
    label: "Big Data",
    icon: ICN_ON_GOING,
    link: "",
    desc: "Design, build, analyze Big Data Solutions",
  },
  {
    label: "Machine Learning",
    icon: ICN_ON_GOING,
    link: "",
    desc: "Write distributed Machine Learning models that scale",
  },
  {
    label: "Security Backups & Recovery",
    icon: ICN_ON_GOING,
    link: "",
    desc: "Stay compliant, protect information, data application and infrastructure",
  },
];
...
<<<<<<< HEAD
  ...
  const getAllLabCategories = () => {
    try {
      spinner.show();
      RestService.getAllLabCategories()
        .then(
          (response) => {
  ...
  return (
    <div className="table-shadow p-3">
      ...
      <div className="flx tab-btn-group mb-3">
        <TabBtn
          active={location.state.subPath === "labstore"}
          onClick={() =>
            navigate("/labstore", {
              state: {
                title: "Lab Store",
        ...
        {/* <TabBtn
          active={location.state.subPath === "mylab"}
          onClick={() =>
            navigate("/labstore/mylab", {
              state: {
                title: "Lab Store",
                subTitle: "My Lab",
                subPath: "mylab",
